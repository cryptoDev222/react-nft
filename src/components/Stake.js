  ...
  return (
    <Grid container className = {classes.root}>
      <Grid item xs={12} md={12}  container direction="column" justify="space-between" alignItems="flex-start" spacing={1}>
        <Grid container direction="row" alignItems="center">
          <Grid className={classes.icon} container justify="center" alignItems="center">
            ...
            <Select className={classes.selectElem} options={femaleData} onChange={handleChange} />
        </Grid>
        <Grid container direction="row" alignItems="center">
          <Grid className={classes.icon} container justify="center" alignItems="center">
      ...
      <Grid item xs={12} md={12} container alignItems="flex-end" justify="center">
        <Button onClick={() => stake(value, valueM, valueB)} variant="contained" color="primary" className={classes.button}>
          STAKE
        </Button>
      </Grid>
    </Grid>
